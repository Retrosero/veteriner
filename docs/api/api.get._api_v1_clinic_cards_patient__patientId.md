# GET /api/v1/clinic/cards/patient/:patientId

**Modül:** `clinic`  
**Endpoint:** `docs/api/api.get._api_v1_clinic_cards_patient__patientId.md`  
**Yöntem:** `GET`  
**Yol:** `/api/v1/clinic/cards/patient/:patientId`
