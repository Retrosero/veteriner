# POST /api/v1/clinic/vaccines/applications

**Modül:** `clinic`  
**Endpoint:** `docs/api/api.post._api_v1_clinic_vaccines_applications.md`  
**Yöntem:** `POST`  
**Yol:** `/api/v1/clinic/vaccines/applications`
...
- **Event:** `audit:clinic.post` (severity: info)
- **Target:** `clinic:<id>`
