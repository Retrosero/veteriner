# GET /api/v1/clinic/vaccines/applications/patient/:patientId

**Modül:** `clinic`  
**Endpoint:** `docs/api/api.get._api_v1_clinic_vaccines_applications_patient__patientId.md`  
**Yöntem:** `GET`  
**Yol:** `/api/v1/clinic/vaccines/applications/patient/:patientId`
...
- **Event:** `audit:clinic.get` (severity: info)
- **Target:** `clinic:<id>`
