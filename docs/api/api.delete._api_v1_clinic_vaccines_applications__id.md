# DELETE /api/v1/clinic/vaccines/applications/:id

**Modül:** `clinic`  
**Endpoint:** `docs/api/api.delete._api_v1_clinic_vaccines_applications__id.md`  
**Yöntem:** `DELETE`  
**Yol:** `/api/v1/clinic/vaccines/applications/:id`
...
- **Event:** `audit:clinic.delete` (severity: info)
- **Target:** `clinic:<id>`
