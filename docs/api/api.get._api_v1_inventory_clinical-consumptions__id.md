# GET /api/v1/inventory/clinical-consumptions/:id

**Modül:** `inventory`  
**Endpoint:** `docs/api/api.get._api_v1_inventory_clinical-consumptions__id.md`  
**Yöntem:** `GET`  
**Yol:** `/api/v1/inventory/clinical-consumptions/:id`
