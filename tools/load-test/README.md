...
- k6 script üreticisi + shared.js şablonu (12 test)
...
- k6 scriptleri env (`__ENV`) üzerinden konfigüre olur; üretim
  CI/CD'de `BASE_URL`, `AUTH_TOKEN`, `TENANT_ID` set edilmeli.
- Bu core tick yalnızca altyapı + senaryo + threshold + rapor
  motorunu içerir. Sonraki tick'lerde:
  - docs/RAG chunk üretimi (senaryo açıklamaları)
  - i18n key parity
  - Pilot ortamında gerçek k6 run + rapor ekleme
  - Threshold konfigürabləşdirməsi (env'den override)
