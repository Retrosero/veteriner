    ...
    steps: [
      {
        ...
        body: {
          ...
          lastName: "Musteri",
          phone: "+905550000001",
          email: "pilot.musteri@example.com",
        },
        expectStatus: 201,
        expectField: "id",
      },
    ...
    steps: [
      {
        ...
        method: "GET",
        path: "/api/v1/calendar?date=today&limit=50",
        expectStatus: 200,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: { notes: "Saglikli, kontrol 6 ay sonra" },
        expectStatus: 200,
      },
    ],
  },
    ...
    steps: [
      {
        ...
        body: {
          patientId: "{patientId}",
          vaccineProtocolId: "{vaccineProtocolId}",
          administeredAt: "2026-08-02T11:00:00.000Z",
          lotNumber: "PILOT-LOT-001",
        },
        expectStatus: 201,
        expectField: "id",
      },
