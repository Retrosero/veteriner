...
OWASP ASVS yaklaşımıyla kimlik doğrulama, yetkilendirme, IDOR, XSS, CSRF, SQL injection, dosya yükleme, rate limit ve tenant izolasyonu testlerini çalıştır.

Bulunan sorunları severity ile raporla ve yüksek riskli açıkları düzelt.
