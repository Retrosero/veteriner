# GOAL-114 — Türkçe kullanıcı eğitim merkezi
...
Uygulama içinde erişilebilen Türkçe eğitim merkezi geliştir.

İçerikler modül ve sayfa bağlamında gösterilmeli. Arama, kategori ve ilgili içerik bağlantıları bulunmalı.
