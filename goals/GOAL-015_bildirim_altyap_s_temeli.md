...
SMS, e-posta, uygulama içi bildirim ve ileride WhatsApp için ortak bildirim altyapısı kur.
...
- Kullanıcı iletişim izinleri

Gerçek sağlayıcı entegrasyonu yerine mock provider kullan.
