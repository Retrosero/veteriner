# GOAL-132 — WhatsApp entegrasyonu
...
Onaylı WhatsApp Business sağlayıcısı üzerinden randevu ve aşı bildirimleri için adapter geliştir.

Template onayı, opt-in, delivery status ve hata logları desteklenmeli.
