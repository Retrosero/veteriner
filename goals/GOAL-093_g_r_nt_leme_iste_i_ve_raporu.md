# GOAL-093 — Görüntüleme isteği ve raporu
...
Röntgen, ultrason ve diğer görüntüleme işlemleri için istek, planlama, dosya ve rapor akışını geliştir.

Dosyalar güvenli storage üzerinden tutulmalı. Portal görünürlüğü ayrıca onaylanmalı.
