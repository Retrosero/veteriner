# GOAL-101 — Frontend hata yakalama
...
Next.js runtime, API ve kullanıcı arayüzü hatalarını merkezi sisteme gönderen hata yakalama altyapısı geliştir.

Hata olayları backend request ID ile ilişkilendirilmeli. Hassas form verileri gönderilmemeli.
