...
Tenant bazında modül açma/kapatma altyapısı geliştir.
...
Kapalı modüle frontend route, menü ve API erişimi engellenmeli. SUPERADMIN tenant bazında modül durumunu yönetebilmeli. Değişiklik audit log üretmeli.
