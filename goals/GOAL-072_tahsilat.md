...
Satış veya borç kaydı için tahsilat akışını geliştir.
...
Kısmi tahsilat desteklenmeli. Para değerleri `numeric` kullanılmalı. Aynı idempotency key çift tahsilat üretmemeli.
