# GOAL-118 — Doküman-kod CI doğrulaması
...
CI içinde aşağıdaki durumları hata kabul eden doğrulama geliştir:

- Dokümansız route
- Dokümansız permission
- Katalogda bulunmayan error code
- Alan sözlüğünde olmayan form alanı
- Eksik tr-TR veya en-GB i18n anahtarı
- Güncellenmemiş sayfa versiyonu
