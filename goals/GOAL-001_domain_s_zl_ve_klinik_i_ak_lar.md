# GOAL-001 — Domain sözlüğü ve klinik iş akışları
...
Pilot kliniğin işleyişi için domain sözlüğü ve uçtan uca iş akışı dokümanlarını oluştur.

Kapsam:

- Hasta sahibi
- Hayvan
- Kedi, köpek ve kuş türleri
- Randevu
- Muayene
- SOAP
- Aşı
...
Her kavram için tanım, ilişkiler, zorunlu alanlar, yaşam döngüsü ve silme/düzeltme kuralları yaz.

Kod yazma. Çıktı, sonraki goal'ların ortak ürün sözleşmesi olacaktır.
