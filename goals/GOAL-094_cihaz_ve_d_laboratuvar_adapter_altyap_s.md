# GOAL-094 — Cihaz ve dış laboratuvar adapter altyapısı
...
Gerçek entegrasyon yapmadan laboratuvar cihazları ve dış laboratuvarlar için adapter sözleşmesi kur.
