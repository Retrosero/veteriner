...
Hayvan için alerji, kronik hastalık, risk ve klinik uyarı kayıtlarını geliştir.

Bu bilgiler hayvan detayında ve muayene ekranında görünür olmalı. Hassas açıklama içerikleri sistem loglarına yazılmamalı.

Düzeltme geçmişi korunmalı. Yetkisiz personel klinik uyarı içeriğini değiştirememeli.
