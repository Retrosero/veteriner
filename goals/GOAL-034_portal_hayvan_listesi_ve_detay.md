...
Hasta sahibi portalında kullanıcının yalnızca kendi hayvanlarını görebilmesini sağla.

Gösterilecekler:

- Temel bilgiler
- Klinik tarafından paylaşılmasına izin verilen aşılar
- Yaklaşan randevular
- Paylaşılan belgeler
- Klinik iletişim bilgileri

Başka sahip veya tenant verisine erişim negatif testlerle engellenmeli.
