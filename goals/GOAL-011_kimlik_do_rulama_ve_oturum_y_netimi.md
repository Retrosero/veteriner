...
Personel paneli için güvenli kimlik doğrulama ve oturum yönetimi geliştir.

Kapsam:

- Kullanıcı daveti
- İlk parola oluşturma
- Giriş/çıkış
- Parola sıfırlama
- Oturum yenileme
...
- Tenant ve branch context üretimi

Portal kullanıcı kimlik doğrulaması bu goal kapsamında değildir.
