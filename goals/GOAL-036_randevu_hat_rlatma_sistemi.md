...
Yaklaşan randevular için queue tabanlı hatırlatma sistemi geliştir.

Kurallar:

- Tenant bazlı zamanlama
- Locale bazlı mesaj
- Kullanıcı iletişim izni
- Idempotent job
- Retry
- Delivery status
- İptal edilen randevuya mesaj gönderilmemesi
