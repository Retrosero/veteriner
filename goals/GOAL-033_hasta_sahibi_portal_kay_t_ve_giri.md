# GOAL-033 — Hasta sahibi portalı kayıt ve giriş
...
PET_OWNER_PORTAL rolü için ayrı kimlik doğrulama ve portal layout'u geliştir.

Kurallar:

- Davet üzerinden kayıt
- E-posta/telefon doğrulama
- Parola sıfırlama
- Kendi tenant ve sahiplik kayıtlarıyla sınırlandırma
- Personel panelinden ayrı session ve izinler
- Brute-force ve güvenlik logları
