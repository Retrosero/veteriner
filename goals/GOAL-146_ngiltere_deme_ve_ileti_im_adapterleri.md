# GOAL-146 — İngiltere ödeme ve iletişim adapterleri
...
İngiltere'de seçilecek ödeme, SMS ve e-posta sağlayıcılarını mevcut adapter altyapısına bağla.

Tenant bazlı provider seçimi, locale, delivery status, webhook güvenliği ve hata logları desteklenmeli.
