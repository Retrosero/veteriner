...
Bir hayvanın sahiplik geçmişini yöneten modülü geliştir.

Kurallar:

- Sahip değişikliği eski ilişkiyi silmez.
- Başlangıç ve bitiş tarihi tutulur.
- Aktif sahip tek olmalı.
- Değişiklik nedeni kaydedilmeli.
- Portal erişimleri yeni sahiplik durumuna göre güncellenmeli.
- İşlem audit üretmeli.
