...
Muayene içinde SOAP kayıt yapısını geliştir.
...
Kayıt autosave/taslak desteklemeli. Finalize edilen kayıt doğrudan üzerine yazılmamalı. Değişiklikler amendment/versiyon olarak saklanmalı.
