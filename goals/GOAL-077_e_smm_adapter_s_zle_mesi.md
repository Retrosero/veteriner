# GOAL-077 — e-SMM adapter sözleşmesi
...
Gerçek e-SMM entegrasyonu yapmadan ülke adaptörü içinde e-SMM provider interface'i oluştur.
...
- Status
- Error mapping
- Retry/idempotency beklentileri
- Mock provider
- Gelecek entegrasyon dokümanı

MVP'de kullanıcı manuel belge numarası girebilmeli.
