# GOAL-085 — Yatış order ve uygulama kayıtları
...
Yatışta ilaç, beslenme, ölçüm, bakım ve kontrol order'ları oluşturma ve uygulama kaydı akışını geliştir.

Planlanan ve uygulanan kayıt ayrı tutulmalı. Kaçırılan/geciken order görünür olmalı.
