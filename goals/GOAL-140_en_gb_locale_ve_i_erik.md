# GOAL-140 — en-GB locale ve içerik
...
Tüm kullanıcı arayüzünü ve kullanıcı eğitim içeriğini en-GB locale ile tamamla.

Tarih, saat, para, sayı ve terminoloji İngiltere kullanımına uygun olmalı. Eksik çeviri CI hatası üretmeli.
