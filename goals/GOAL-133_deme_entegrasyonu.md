...
Hasta sahibi portalında online ödeme için seçilecek Türkiye ödeme sağlayıcısını adapter yapısına bağla.

3D Secure, webhook doğrulama, idempotency, kısmi ödeme, başarısız ödeme ve ters kayıt senaryolarını destekle.
