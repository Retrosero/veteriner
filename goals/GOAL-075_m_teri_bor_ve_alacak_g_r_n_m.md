# GOAL-075 — Müşteri borç ve alacak görünümü
...
Hasta sahibi/müşteri detayında borç, tahsilat ve işlem geçmişi görünümü geliştir.

Kısmi ödeme, iade ve ters kayıtlar doğru hesaplanmalı. Rapor query'leri tenant ve branch scope'a uymalı.
