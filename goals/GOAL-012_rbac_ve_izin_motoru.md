...
GOAL-002'de tanımlanan rol ve izin matrisini backend ve frontend'de uygula.

Kurallar:

- Gerçek yetki kontrolü backend'de yapılmalı.
- Frontend yalnızca görünürlük ve kullanıcı deneyimi sağlar.
- Permission guard/decorator altyapısı kurulmalı.
- SUPERADMIN ayrı erişim katmanına sahip olmalı.
- Branch scope desteklenmeli.
- Yetki değişiklikleri audit üretmeli.

Her rol için pozitif ve negatif API testleri yaz.
