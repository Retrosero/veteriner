# GOAL-134 — Resmî veteriner sistemleri adapter hazırlığı
...
PETVET, e-reçete, İTS veya ATS için yalnızca doğrulanmış resmi teknik doküman ve erişim varsa entegrasyon geliştir.

Erişim yoksa:

- Uyumlu veri alanları
- Eksik bilgi kontrolü
- Dışa aktarma
- Manuel işlem yardım ekranı
  oluştur.

Doğrulanmamış endpoint veya otomasyon kullanılmamalı.
