# GOAL-054 — Aşı amendment ve düzeltme
...
Hatalı aşı kayıtlarının geçmişi silinmeden düzeltilmesini sağlayan amendment akışı geliştir.

Düzeltmede:

- Eski kayıt korunmalı.
- Yeni değerler saklanmalı.
- Neden zorunlu olmalı.
- Stok etkisi varsa ters ve yeni hareket oluşmalı.
