# GOAL-144 — Fiyat şeffaflığı ve estimate
...
İngiltere pazarı için yayınlanabilir fiyat listesi, tedavi estimate'i, müşteri onayı ve estimate-gerçek fatura fark görünümünü geliştir.

Web sitesine gömülebilir fiyat bileşeni için API sözleşmesi oluştur.
