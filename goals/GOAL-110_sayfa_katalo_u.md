...
Tüm mevcut frontend route'larını makinece okunabilir sayfa kataloğuna bağla.

Her sayfa için amaç, roller, izinler, alanlar, eylemler, hata durumları, ilgili API ve yardım anahtarları yaz.
