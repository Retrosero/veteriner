# GOAL-105 — Güvenlik logları ve alarm kuralları
...
Başarısız giriş, yetkisiz erişim, şüpheli veri indirme, rol değişikliği ve tenant izolasyonu ihlal girişimleri için güvenlik logları geliştir.

Kritik olaylarda alarm adapteri tetiklenmeli.
