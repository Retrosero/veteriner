# GOAL-106 — PII maskeleme ve log retention
...
Log pipeline içinde kişisel ve klinik verileri maskeleyen ortak sanitizer geliştir.

Retention ve arşivleme kuralları tenant, log türü ve severity bazında uygulanabilir olmalı.
