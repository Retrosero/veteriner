# GOAL-115 — Context-aware yardım endpoint'i
...
Kullanıcı rolü, tenant modülleri, locale, mevcut route ve seçili kayıt bağlamına göre uygun yardım içeriği döndüren endpoint geliştir.

Bu endpoint tıbbi öneri üretmemeli.
