# GOAL-092 — Laboratuvar sonuçları
...
Laboratuvar sonuç girişi, referans dışı değer işaretleme, dosya ekleme ve veteriner onayı akışını geliştir.

Sonuç finalize edildikten sonra amendment olmadan değiştirilememeli.
