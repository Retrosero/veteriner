# GOAL-131 — SMS sağlayıcı entegrasyonu
...
Türkiye'deki seçili SMS sağlayıcısını notification adapterine bağla.

Teslim durumu, hata kodu, retry, maliyet logu ve tenant bazlı sender ayarları desteklenmeli.
